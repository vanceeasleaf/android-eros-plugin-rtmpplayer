...
@WeexComponent(names = "player")
public class WXPVideo extends  WXVContainer<VideoView>{
    Timer timer;
    boolean compelete;
    String title;
    boolean autoPlay;
    public WXPVideo(WXSDKInstance instance, WXDomObject node, WXVContainer parent) {
...
//        VideoPlayerView player=new VideoPlayerView(context);
        ...
        qsVideoView.instace=this.getInstance();// this.mInstance;
